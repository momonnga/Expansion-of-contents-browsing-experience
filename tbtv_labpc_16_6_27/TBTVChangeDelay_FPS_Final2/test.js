...
$.ajax({
  ...
  if(ready==1){
    ...
    if(type=="NULL"){
      ...
      if(cx>0&&cx<3000&&cy>0&&cy<1500){
        if(Math.floor(cx/50)>0&&Math.floor(cx/50)<79&&Math.floor(cy/50)>0&&Math.floor(cy/50)<79){
          if(Math.floor(cx/50)>40){
            //console.log("40ijou");
          }
          //console.log(Math.floor(cx/50));
      ...
      for(var i=0;i<60;i++ ){
        ...
        //ctx.drawImage(image,0,0,2000,1000);
          ...
          if(number<1){
            ...
            ctx.drawImage(image,i*50,50,50,50,i*50,j*50,50,50);
          }
        }
      }
      ctx.globalCompositeOperation = "source-over";
    ...
    if(recordFlag==1){
      ...
      if(id!="sm9"){
          recordPos[recordPos.length]=type+","+cxLog+","+cyLog+","+document.body.scrollLeft+","+document.body.scrollTop+","+Year+"-"+Month+"-"+Day+"-"+H+"-"+M+"-"+S+"-"+MS+","+player.ext_getStatus()+","+player.ext_getPlayheadTime()+","+player.ext_getVideoSize()+","+arJSON.TimeMS+","+DLevel+"\r\n";
      }else if(exp=="experiment"){
        recordPos[recordPos.length]=type+","+cxLog+","+cyLog+","+document.body.scrollLeft+","+document.body.scrollTop+","+Year+"-"+Month+"-"+Day+"-"+H+"-"+M+"-"+S+"-"+MS+","+getCurrentPS()+","+getCurrentVT()+","+arJSON.TimeMS+","+DLevel+"\r\n";
      }else{
        recordPos[recordPos.length]=type+","+cxLog+","+cyLog+","+document.body.scrollLeft+","+document.body.scrollTop+","+Year+"-"+Month+"-"+Day+"-"+H+"-"+M+"-"+S+"-"+MS+","+arJSON.TimeMS+","+DLevel+"\r\n";    
      }
    }
  }
  setTimeout(listenTobii,DLevel);
...
if(typeR==undefined){
  ...
  if(typeR=="NULL"){
    ...
    ctxR.globalCompositeOperation = "destination-out";
    if(cxR>0&&cxR<2500&&cyR>0&&cyR<1500){
      if(Math.floor(cxR/50)>0&&Math.floor(cxR/50)<79&&Math.floor(cyR/50)>0&&Math.floor(cyR/50)<79){
            
          array[Math.floor(cxR/50)][Math.floor(cyR/50)-1]=33;
          array[Math.floor(cxR/50)-1][Math.floor(cyR/50)]=33;
          array[Math.floor(cxR/50)+1][Math.floor(cyR/50)]=33;
          array[Math.floor(cxR/50)][Math.floor(cyR/50)+1]=33;
          array[Math.floor(cxR/50)-1][Math.floor(cyR/50)-1]=50;
          array[Math.floor(cxR/50)-1][Math.floor(cyR/50)+1]=50;
          array[Math.floor(cxR/50)+1][Math.floor(cyR/50)-1]=50;
          array[Math.floor(cxR/50)+1][Math.floor(cyR/50)+1]=50;
          array[Math.floor(cxR/50)][Math.floor(cyR/50)]=0;
      }
    }
    for(var i=0;i<60;i++ ){
      for(var j=0;j<30;j++){
