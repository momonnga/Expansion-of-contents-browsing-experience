...
//ifの条件式がちゃんと＝＝になっているかチェック
  ...
  if(recordFlag==1){
    ...
    if(id!="sm9"){
        recordPos[recordPos.length]=type+","+cxLog+","+cyLog+","+document.body.scrollLeft+","+document.body.scrollTop+","+Year+"-"+Month+"-"+Day+"-"+H+"-"+M+"-"+S+"-"+MS+","+player.ext_getStatus()+","+player.ext_getPlayheadTime()+","+player.ext_getVideoSize()+","+arJSON.TimeMS+"\r\n";
    }else if(exp=="experiment"){
      recordPos[recordPos.length]=type+","+cxLog+","+cyLog+","+document.body.scrollLeft+","+document.body.scrollTop+","+Year+"-"+Month+"-"+Day+"-"+H+"-"+M+"-"+S+"-"+MS+","+getCurrentPS()+","+getCurrentVT()+","+arJSON.TimeMS+"\r\n";
    }else{
